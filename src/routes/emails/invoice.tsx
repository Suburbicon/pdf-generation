...
export const emailInvoiceRoute: FastifyPluginCallback = (fastify, _, done) => {
  ...
  fastify.withTypeProvider<ZodTypeProvider>().route({
    ...
    onResponse(req, reply, done) {
      const endpoint = `invoice_email_${snakeCase(req.headers['x-tenant'])}`;
