  ...
  return (
    <View wrap={false} style={[styles.root, style]}>
      <View style={styles.table}>
        ...
        {pricing.tickets.map((item, index) => (
          <View key={index}>
            <View
              style={{
                marginTop: CSS.px(index === 0 ? 8 : 16),
            ...
            {item.modifiers?.length &&
              item.modifiers.map(mod => (
                ...
                >
                  <View style={{ width: '50%', paddingRight: CSS.px(20) }}>
                    <Text style={styles.cell}>{mod.title}</Text>
                  </View>
                  <View style={{ width: '20%' }}>
                    {mod.amount && (
                      <Text style={styles.cell}>{mod.amount}</Text>
                    )}
                  </View>
                  <View style={{ width: '10%', alignItems: 'center' }}>
                    <Text style={styles.cell}>{mod.count}</Text>
                  </View>
                  <View style={{ width: '20%', alignItems: 'flex-end' }}>
                    <Text style={styles.cell}>{mod.amount}</Text>
                  </View>
